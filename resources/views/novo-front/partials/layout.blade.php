...
<head>
    ...
    {{-- Protótipo de comparação — nunca deve ser indexado --}}
    ...
    {{-- Material Symbols — ícones usados no novo design das páginas públicas --}}
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=block" rel="stylesheet" media="print" onload="this.media='all'">
...
<body id="top">
    ...
    @include('novo-front.partials.header')
    ...
    /* Espaço para a bottom-nav do protótipo — logo + bottom bar, sem hamburger */
    ...
    @include('novo-front.partials.mobile-bottom-nav')
    <script>
    (function() {
