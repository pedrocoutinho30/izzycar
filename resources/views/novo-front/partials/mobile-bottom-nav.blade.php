{{-- Barra de navegação fixa no fundo do ecrã — única navegação mobile deste
     protótipo (substitui o menu hamburger). Por pedido: sem Simulador de
     Custos e sem Pedir Cotação — ficam só os 5 destinos principais. --}}
@php
    $mbnItems = [
        [
            'label' => 'Home',
            'route' => 'novo-front.home',
            'active' => request()->routeIs('novo-front.home') || request()->routeIs('frontend.home'),
