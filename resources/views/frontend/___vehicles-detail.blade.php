...
<section class="py-5 bg-light">
    <div class="container">
        <div class="row g-5">
            <!-- Coluna com imagens -->
            <div class="col-lg-6 border-gallery">
                ...
                <div class="swiper mySwiperThumbs mt-3">
                    <div class="swiper-wrapper">
                        @foreach ($vehicle->images as $key => $image)
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-8 mt-4">
                                    <h2 class="text-white">{{ $vehicle->brand }}</h2>
                                    <h5 class="text-white"> {{ $vehicle->model }} {{ $vehicle->version }}</h5>

                                </div>
                                <div class="col-4 mt-4">
                                    <h3 class="d-flex align-items-end" style="color: var(--accent-color);">
