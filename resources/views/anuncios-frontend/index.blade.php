            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 text-center">
                        <h3 class="mb-4">Os nossos carros</h3>
                    </div>
                                    ...
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <p class="mb-1 text-muted"> {{$vehicle->kilometers}} km • {{$vehicle->year}}</p>
                                                <p class="mb-1 text-muted">Combustivel • Transmissão • COR</p>
                                            </div>

                                            <div class="text-end">
                                                <h5 class="text-primary mb-0">{{ number_format($vehicle->sell_price, 0, ',', '.') }} €</h5>
                                                <span class="badge bg-secondary mt-2">{{$vehicle->reference}}</span>
                                            </div>
                                        </div>

                                        <a href="{{ route('vehicles.show', $vehicle->id) }}" class="btn custom-btn mt-3">Ver detalhes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
