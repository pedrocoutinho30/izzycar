...
<div class="admin-content">
    ...
    <div class="content-header">
        <div>
            <h1 class="content-title">{{ isset($convertedProposal) ? 'Editar Proposta Convertida' : 'Nova Proposta Convertida' }}</h1>
            <p class="content-subtitle">Gestão do processo de importação</p>
        </div>
        <div class="content-actions">
            <a href="{{ route('admin.v2.converted-proposals.index') }}" class="btn btn-outline-secondary">
    ...
    <form action="{{ isset($convertedProposal) ? route('admin.v2.converted-proposals.update', $convertedProposal->id) : route('admin.v2.converted-proposals.store') }}" 
        ...
        <div class="form-section">
            <div class="form-section-header">
                <h3 class="form-section-title">
                    <i class="bi bi-cash-stack"></i> Custos de Importação
                </h3>
            </div>
        ...
        <div class="form-section">
            <div class="form-section-header">
                <h3 class="form-section-title">
                    <i class="bi bi-wallet2"></i> Valores e Pagamentos
                </h3>
            </div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary btn-lg">
                <i class="bi bi-check-lg"></i> {{ isset($convertedProposal) ? 'Atualizar Proposta' : 'Criar Proposta Convertida' }}
            </button>
            <a href="{{ route('admin.v2.converted-proposals.index') }}" class="btn btn-outline-secondary btn-lg">
                Cancelar
            </a>
        </div>
    </form>
