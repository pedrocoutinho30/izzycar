...
@section('title', 'Pipeline das Minhas Leads')
...
@include('components.admin.page-header', [
    ...
    'title' => 'Pipeline das Minhas Leads',
    'subtitle' => 'Arraste os cartões entre colunas para actualizar o estado',
])

{{-- Toggle lista / kanban --}}
<div class="d-flex justify-content-end mb-3 gap-2">
    <a href="{{ route('admin.angariador.leads') }}" class="btn btn-outline-secondary btn-sm">
        <i class="bi bi-list-ul me-1"></i> Vista de Lista
    </a>
    <a href="{{ route('admin.angariador.leads.kanban') }}" class="btn btn-primary-modern btn-sm active">
        ...
        <div class="kanban-col__body" id="col-{{ $statusKey }}">
            ...
            <div class="kanban-card {{ $fuBadge ? 'kanban-card--alert' : '' }}" data-id="{{ $lead->id }}" draggable="true">
                <div class="kanban-card__top">
                    ...
                    <a href="{{ route('admin.angariador.leads.show', $lead->id) }}"
...
(function () {
    ...
    document.querySelectorAll('.kanban-col__body').forEach(col => {
        ...
        col.addEventListener('drop', async e => {
            ...
            try {
                const res = await fetch(`/gestao/angariador/leads/${leadId}/status`, {
                    method: 'POST',
                    headers: {
